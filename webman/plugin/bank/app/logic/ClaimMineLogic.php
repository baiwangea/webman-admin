...
use plugin\bank\app\model\ClaimMine;

/**
 * 挖矿领取逻辑层
 */
class ClaimMineLogic extends BaseLogic
{
    /**
     * 构造
     */
    ...
    public function search(array $searchWhere = []): mixed
    {
        ...
        if (!empty($searchWhere['mine_id'])) {
            $query->where('mine_id', $searchWhere['mine_id']);
        }
