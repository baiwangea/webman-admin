 ...
 * 流水账单记录验证器
 */
class WaterBillsRecordValidate extends BaseValidate
{
    /**
     * 定义验证规则
     */
    ...
    protected $message = [
        ...
        'transaction_hash.max' => '交易哈希长度不能超过66个字符',
    ...
    protected $scene = [
        ...
        'update' => ['user_addr', 'type', 'amount', 'balance_before', 'balance_after', 'transaction_hash', 'description', 'status'],
    ];
}