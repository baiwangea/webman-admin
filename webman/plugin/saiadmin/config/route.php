...
Route::group('/tool', function () {
    ...
    // 谷歌验证码
    Route::get("/googleAuth/getBindInfo",[\plugin\saiadmin\app\controller\GoogleAuthController::class, 'getBindInfo']);
    Route::post("/googleAuth/bind",[\plugin\saiadmin\app\controller\GoogleAuthController::class, 'bind']);
    Route::post("/googleAuth/unbind",[\plugin\saiadmin\app\controller\GoogleAuthController::class, 'unbind']);
    Route::post("/googleAuth/verify",[\plugin\saiadmin\app\controller\GoogleAuthController::class, 'verify']);
    Route::get("/googleAuth/generateSecret",[\plugin\saiadmin\app\controller\GoogleAuthController::class, 'generateSecret']);
});
